...
EPIC_MONO=""
if [ -f "D:\Oddin\Engine\Build\BatchFiles\Mac\SetupMono.sh" ]; then
    pushd "D:\Oddin\Engine\Build\BatchFiles\Mac"
	source SetupMono.sh
    popd
else
	EPIC_MONO="NOTE: It seems this $0 was built from another platform and copied here.\nNOTE: Was expecting to setup mono via: "'D:\Oddin\Engine\Build\BatchFiles\Mac\SetupMono.sh';
fi
